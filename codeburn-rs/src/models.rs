...
const FALLBACK_PRICING: &[(&str, ModelCosts)] = &[
    ...
    ("gpt-4.1-mini", ModelCosts { input: 0.4e-6, output: 1.6e-6, cache_write: 0.4e-6, cache_read: 0.1e-6, web_search: WEB_SEARCH_COST, fast_multiplier: 1.0 }),
    ("gpt-4.1-nano", ModelCosts { input: 0.1e-6, output: 0.4e-6, cache_write: 0.1e-6, cache_read: 0.025e-6, web_search: WEB_SEARCH_COST, fast_multiplier: 1.0 }),
    ("gpt-4.1", ModelCosts { input: 2.0e-6, output: 8.0e-6, cache_write: 2.0e-6, cache_read: 0.5e-6, web_search: WEB_SEARCH_COST, fast_multiplier: 1.0 }),
    ...
    ("gemini-3-pro", ModelCosts { input: 1.25e-6, output: 10e-6, cache_write: 1.25e-6, cache_read: 0.315e-6, web_search: WEB_SEARCH_COST, fast_multiplier: 1.0 }),
    ("gemini-3-flash", ModelCosts { input: 0.15e-6, output: 0.6e-6, cache_write: 0.15e-6, cache_read: 0.0375e-6, web_search: WEB_SEARCH_COST, fast_multiplier: 1.0 }),
    ...
    ("gemini-2.5-flash", ModelCosts { input: 0.15e-6, output: 0.6e-6, cache_write: 0.15e-6, cache_read: 0.0375e-6, web_search: WEB_SEARCH_COST, fast_multiplier: 1.0 }),
    ("gemini-2.0-flash", ModelCosts { input: 0.1e-6, output: 0.4e-6, cache_write: 0.1e-6, cache_read: 0.025e-6, web_search: WEB_SEARCH_COST, fast_multiplier: 1.0 }),
    ("gpt-5-mini", ModelCosts { input: 0.4e-6, output: 1.6e-6, cache_write: 0.4e-6, cache_read: 0.2e-6, web_search: WEB_SEARCH_COST, fast_multiplier: 1.0 }),
    ...
    ("o4-mini", ModelCosts { input: 1.1e-6, output: 4.4e-6, cache_write: 1.1e-6, cache_read: 0.275e-6, web_search: WEB_SEARCH_COST, fast_multiplier: 1.0 }),
    ("o3", ModelCosts { input: 10e-6, output: 40e-6, cache_write: 10e-6, cache_read: 2.5e-6, web_search: WEB_SEARCH_COST, fast_multiplier: 1.0 }),
];
